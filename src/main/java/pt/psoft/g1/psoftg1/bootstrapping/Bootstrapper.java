...
public class Bootstrapper implements CommandLineRunner {
    ...
    private void createAuthors() {
        if (authorRepository.searchByNameName("Manuel Antonio Pina").isEmpty()) {
            String authorIdGenerated = idGenerator.generateId();
            final Author author = new Author(authorIdGenerated, "Manuel Antonio Pina",
        ...
        if (authorRepository.searchByNameName("Antoine de Saint Exupéry").isEmpty()) {
            String authorIdGenerated = idGenerator.generateId();
            final Author author = new Author(authorIdGenerated,"Antoine de Saint Exupéry",
        ...
        if (authorRepository.searchByNameName("Alexandre Pereira").isEmpty()) {
            String authorIdGenerated = idGenerator.generateId();
            final Author author = new Author(authorIdGenerated, "Alexandre Pereira",
        ...
        if (authorRepository.searchByNameName("Filipe Portela").isEmpty()) {
            String authorIdGenerated = idGenerator.generateId();
            System.out.println(authorIdGenerated);
            final Author author = new Author(authorIdGenerated,"Filipe Portela",
        ...
        if (authorRepository.searchByNameName("Ricardo Queirós").isEmpty()) {
            String authorIdGenerated = idGenerator.generateId();
            final Author author = new Author(authorIdGenerated, "Ricardo Queirós",
        ...
        if (authorRepository.searchByNameName("Freida Mcfadden").isEmpty()) {
            String authorIdGenerated = idGenerator.generateId();
            final Author author = new Author(authorIdGenerated, "Freida Mcfadden",
        ...
        if (authorRepository.searchByNameName("J R R Tolkien").isEmpty()) {
            String authorIdGenerated = idGenerator.generateId();
            final Author author = new Author(authorIdGenerated, "J R R Tolkien",
        ...
        if (authorRepository.searchByNameName("Gardner Dozois").isEmpty()) {
            String authorIdGenerated = idGenerator.generateId();
            final Author author = new Author(authorIdGenerated, "Gardner Dozois",
        ...
        if (authorRepository.searchByNameName("Lisa Tuttle").isEmpty()) {
            String authorIdGenerated = idGenerator.generateId();
            final Author author = new Author(authorIdGenerated, "Lisa Tuttle",
