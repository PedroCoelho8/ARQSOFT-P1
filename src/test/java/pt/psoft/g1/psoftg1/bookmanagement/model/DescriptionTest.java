...
class DescriptionTest {
    ...
    @Test
    void ensureDescriptionCanBeNullMelhorado() {
        // Act
        Description description = new Description(null);

        // Assert
        assertNotNull(description); // Verifica se a instância de Description foi criada
        assertNull(description.getDescription()); // Verifica se o valor da descrição é realmente null
    }
    ...
    @Test
    void ensureDescriptionMustNotBeOversizeMelhorado() {
        // Arrange
        ...
        // Act & Assert
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> new Description(longDescription));

        // Verifica se a mensagem de erro está correta
        assertEquals("Description has a maximum of 4096 characters", exception.getMessage());
    }

    //nao me parece que estes precisem de ser alterados
    @Test
    ...
    @Test
    void ensureDescriptionCanBeEmpty() {
        // Act
        Description description = new Description("");

        // Assert
        assertNotNull(description); // Instance should be created
        assertNull(description.getDescription()); // Description should be null
    }

    @Test
    void ensureDescriptionCanBeWhitespace() {
        // Act
        Description description = new Description("   ");
    ...
    @Test
    void ensureDescriptionCanBeExactMaxLength() {
        // Arrange
        String longDescription = "a".repeat(4096); // Create a string of exactly 4096 characters
    ...
    @Test
    void ensureDescriptionMustNotBeMoreThanMaxLength() {
        // Arrange
        String tooLongDescription = "a".repeat(4097); // Create a string of 4097 characters
    ...
    @Test
    void ensureToStringReturnsNullForEmptyDescription() {
        // Act
        Description description = new Description(null);

        // Assert
        assertNull(description.toString()); // toString should return null
    }
