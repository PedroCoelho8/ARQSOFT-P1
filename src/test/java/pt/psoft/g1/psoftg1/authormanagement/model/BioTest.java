...
public class BioTest {
    ...
    @Test
    void ensureBioMustNotBeNull_thenThrowsException() {
        // Arrange
        String expectedMessage = "Bio cannot be null";

        // Act + Assert
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> new Bio(null));
    ...
    @Test
    void ensureBioMustNotBeBlank_thenThrowsException() {
        // Arrange
        String expectedMessage = "Bio cannot be blank";

        // Act + Assert
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> new Bio(""));
    ...
    @Test
    void ensureBioMustNotBeOversize_thenThrowsException() {
        String oversizedBio = "\n" +
                "\n" +
                "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam venenatis semper nisl, eget condimentum felis tempus vitae. Morbi tempus turpis a felis luctus, ut feugiat tortor mattis. Duis gravida nunc sed augue ultricies tempor. Phasellus ultrices in dolor id viverra. Sed vitae odio ut est vestibulum lacinia sed sed neque. Mauris commodo, leo in tincidunt porta, justo mi commodo arcu, non ultricies ipsum dolor a mauris. Pellentesque convallis vulputate nisl, vel commodo felis ornare nec. Aliquam tristique diam dignissim hendrerit auctor. Mauris nec dolor hendrerit, dignissim urna non, pharetra quam. Sed diam est, convallis nec efficitur eu, sollicitudin ac nibh. In orci leo, dapibus ut eleifend et, suscipit sit amet felis. Integer lectus quam, tristique posuere vulputate sed, tristique eget sem.\n" +
                "\n" +
        ...
        String expectedMessage = "Bio has a maximum of 4096 characters";
    ...
    @Test
    void whenBioIsSet_thenBioShouldReturnCorrectValue() {
        // Arrange
        String expectedBioText = "Some bio";

        // Act
        Bio bio = new Bio(expectedBioText);

        // Assert
        assertEquals(expectedBioText, bio.toString());
    }
    ...
    @Test
    void whenBioIsChanged_thenBioShouldReturnUpdatedValue() {
        // Arrange
        String initialBioText = "Some bio";
        String updatedBioText = "Some other bio";
        Bio bio = new Bio(initialBioText);

        // Act
        bio.setBio(updatedBioText);

        // Assert
        assertEquals(updatedBioText, bio.toString());
    }

    //testes criados
    @Test
    void whenCreatingBioWithValidString_thenCreatesBioSuccessfully() {
        Bio bio = new Bio("This is a valid bio.");
        assertEquals("This is a valid bio.", bio.toString());
    }
    @Test
    void whenCreatingBioWithNull_thenThrowsException() {
        Exception exception = assertThrows(IllegalArgumentException.class, () -> new Bio(null));
        assertTrue(exception.getMessage().contains("Bio cannot be null"));
    }
    @Test
    void whenCreatingBioWithBlankString_thenThrowsException() {
        Exception exception = assertThrows(IllegalArgumentException.class, () -> new Bio("   "));
        assertTrue(exception.getMessage().contains("Bio cannot be blank"));
    }
